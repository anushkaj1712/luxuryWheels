/**
 * Axios instance — JWT from auth store, timeouts, slow-network UX, and limited GET retries.
 * Backend JSON shape: `{ success, message, data?, details? }` (see Express error middleware).
 */
